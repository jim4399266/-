...
from src.seq2seq.seq2seq_batcher import Beam_Test_Dataloader
from src.seq2seq.seq2seq_model import Seq2Seq
from src.seq2seq.predict_helper import beam_decode, greedy_decode
...
def test(params):
    ...
    path_checkpoint = Path(params['checkpoint_dir']).joinpath('epoch10.bin')
    ...
    if params['greedy_decode']:
        ...
        b = Beam_Test_Dataloader(test_x_path, test_y_path, params["beam_size"])

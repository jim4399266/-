...
# 验证数据路径
eval_data_path = os.path.join(root, 'data', 'eval.csv')
# 测试数据路径
...
# 词向量路径
save_wv_model_path = os.path.join(root, 'wv', 'word2vec.model')
# 词向量矩阵保存路径
embedding_matrix_path = os.path.join(root, 'wv', 'embedding_matrix')
# 字典路径
vocab_path = os.path.join(root, 'wv', 'vocab.txt')
reverse_vocab_path = os.path.join(root, 'wv', 'reverstest_save_dire_vocab.txt')

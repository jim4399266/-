...
from build_data.build_w2v import build_w2v
from build_data.preprocess import preprocess
from build_data.data_utils import pad_proc, get_max_len, transform_data
...
if __name__ == '__main__':
    # 数据集批量处理
    train_X, train_Y, test_X, test_Y = build_dataset(config.train_data_path, config.eval_data_path)
